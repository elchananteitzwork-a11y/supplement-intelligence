...
function BillingContent() {
  ...
  return (
    <div className="mx-auto max-w-[640px] space-y-8 px-5 pb-24 pt-12 sm:pt-16">
      ...
      {!loading && status && (
        <>
          {/* Current plan / usage */}
          <div className="rounded-xl border border-pi-hairline bg-pi-card p-6 shadow-[0_1px_2px_rgba(22,23,26,0.04)]">
...
// V4 shell pass (2026-07-27): the AppShell wrapper moved to the server
// page.tsx (AvatarMenu world); Suspense stays here because BillingContent
