...
//
// Roadmap M2.14: this broadening logic moved to trends-query-broadening.ts
// (imported above), unchanged, so dataforseo-trends.ts can reuse the exact
// same strategy — this file's own behavior is identical to before.
